...
class ClientNode_ThreadNodeOperations implements Runnable {
	...
	public ClientNode_ThreadNodeOperations(DatagramSocket clientSocket,
			InetAddress IPAddress, int listeningPort, String bsIP) {
	...
	public void run() {
		...
		ClientNode dcCommandHandling = new ClientNode(clientSocket, IPAddress,
				listeningPort, bsIP);
		...
		while (true) {
			...
			System.out.println("10: Display Comment Ranks");
			System.out.println("11: Display File Ranks");
			...
			case 6:
				...
				System.out
						.println("Enter to which message you are going to reply: ");
				...
				dcCommandHandling.commentReply("\"" + sReplyMsg + "\"",
						sCommentMsgToReply);
				break;
			case 7:
			...
			case 9:
				...
				break;
			case 10:
				System.out.println("10: Display Comment Ranks is selected");
				dcCommandHandling.displayCommentRanks();
				break;
			case 11:
				System.out.println("11: Display File Ranks is selected");
				dcCommandHandling.displayFileRanks();
				break;
			case 12:
				System.out.println("12: Leave is selected");
